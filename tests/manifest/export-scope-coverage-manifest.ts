export const exportScopeCoverageManifest: Record<string, string[]> = {
  ...
  'ui/src/components/Content/mermaidContentLifecycle.ts': ['tests/contracts/mermaid-lifecycle-parity.test.ts', 'tests/unit/ui/components/scope-view-modal.test.tsx'],
  ...
  'ui/src/components/Modal/ScopeViewModal.tsx': ['tests/unit/ui/components/scope-view-modal.test.tsx', 'tests/unit/ui/components/scope-view-render-parity.test.tsx', 'tests/unit/ui/components/scope-view-navigation-controls.test.tsx', 'tests/unit/ui/components/scope-view-browser-runtimes.test.tsx'],
  ...
  'ui/src/export/exportExplorerNavigation.ts': ['tests/unit/ui/export/export-html.test.ts', 'tests/unit/ui/export/export-site.test.ts'],
  'ui/src/export/exportHtml.ts': ['tests/unit/ui/export/export-html.test.ts'],
  'ui/src/export/exportJobRunner.ts': ['tests/unit/ui/export/export-job-runner.test.ts'],
  'ui/src/export/exportModel.ts': ['tests/unit/ui/export/export-model.test.ts', 'tests/unit/ui/export/export-job-runner.test.ts'],
  ...
  'ui/src/export/pdf/pdfPrintLayout.ts': ['tests/unit/ui/export/pdf-composer.test.ts'],
  ...
  'ui/src/components/Export/ExportSourceSelect.tsx': ['tests/unit/ui/components/export-source-controls.test.tsx'],
  'ui/src/hooks/useScopeNavigationState.ts': ['tests/unit/ui/hooks/useKeyboard-scope-navigation.test.tsx', 'tests/unit/ui/components/header-navigation-scope.test.tsx'],
  'ui/src/utils/mouseHistoryNavigation.ts': ['tests/unit/ui/utils/mouseHistoryNavigation.test.ts'],
  'ui/src/utils/useModalRegionAnchor.ts': ['tests/contracts/modal-safe-region-contract.test.ts'],
