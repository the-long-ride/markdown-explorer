export const exportScopeCoverageManifest: Record<string, string[]> = {
  'ui/src/components/Export/ExportCenterModal.tsx': ['tests/unit/ui/components/export-center-modal.test.tsx'],
  ...
  'ui/src/export/printExport.ts': ['tests/unit/ui/export/print-export.test.ts'],
