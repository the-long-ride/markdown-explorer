...
export const markdownCorpus: MarkdownFixture[] = [
  ...
  },
  {
    ...
    markdown: '```js\nconsole.log("hello");\n```',
    isMdx: false,
    expectedHtmlInvariants: ['<pre', 'mdn-codeblock', 'console'],
  },
  {
    name: 'code-fence-tilde',
    markdown: '~~~python\nprint("hi")\n~~~',
    isMdx: false,
    expectedHtmlInvariants: ['<pre', 'mdn-codeblock', 'print'],
  },
  {
  ...
  },
  {
    ...
    isMdx: false,
    expectedHtmlInvariants: ['<code class="mdn-inline-code">', 'npm test'],
  },
  {
    name: 'emphasis',
  ...
  },
  {
    ...
    markdown: '1. First\n2. Second\n3. Third',
    isMdx: false,
    expectedHtmlInvariants: ['<ol', '<li class="mdn-list-item">', 'First', 'Second', 'Third'],
  },
  {
    name: 'unordered-list',
    markdown: '- One\n- Two\n- Three',
    isMdx: false,
    expectedHtmlInvariants: ['<ul', '<li class="mdn-list-item">', 'One', 'Two', 'Three'],
  },
  {
    name: 'task-list',
    markdown: '- [ ] Todo\n- [x] Done',
    isMdx: false,
    expectedHtmlInvariants: ['mdn-checkbox', 'mdn-task'],
  },
  {
    name: 'nested-list',
    markdown: '- A\n  - A1\n  - A2\n- B',
    isMdx: false,
    expectedHtmlInvariants: ['<ul', '<li class="mdn-list-item">', 'A', 'A1'],
  },
  {
    name: 'blockquote',
    markdown: '> Quote text\n> More quote',
