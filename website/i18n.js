window.LANGS = {
  en: {
    ...
    dlWinBody:
      "Use the NSIS installer for Start Menu and desktop shortcuts, or the portable `.exe` to run directly without installation. Lightweight builds use Tauri for smaller bundle size with full features.",
    dlWinNsisBtn: "Download Installer",
    dlWinPortableBtn: "Download Portable",
    dlMacTitle: "macOS desktop",
    dlMacBody:
      "Download a `.dmg` for your chip. Use `arm64` for Apple Silicon and `x64` for Intel Macs. Lightweight builds use Tauri for smaller bundle size with full features.",
    dlMacBtn: "Download macOS",
    dlMacArmBtn: "Download Apple Silicon",
    dlMacIntelBtn: "Download Intel",
    dlLinuxTitle: "Linux desktop",
    dlLinuxBody:
      "Use Electron `.AppImage` for portable launch or `.deb` on Debian and Ubuntu-based systems. Lightweight builds use Tauri for smaller bundle size with full features, and are available as AppImage or `.deb`.",
    dlLinuxBtn: "Download Linux",
    dlLinuxAppImageBtn: "Download AppImage",
    dlLinuxDebBtn: "Download .deb",
    dlWinLightweightBtn: "Download Lightweight",
    dlLinuxLightweightAppImageBtn: "Download Lightweight AppImage",
    dlLinuxLightweightDebBtn: "Download Lightweight .deb",
    dlMacLightweightBtn: "Download Lightweight",
  ...
  vi: {
    ...
    dlWinBody:
      "Dùng bộ cài NSIS để có shortcut Start Menu và desktop, hoặc tải `.exe` di động để chạy trực tiếp không cần cài đặt. Bản nhẹ dùng Tauri để giảm dung lượng gói nhưng vẫn đủ tính năng.",
    dlWinBtn: "Tải Windows",
    dlWinNsisBtn: "Tải Bộ cài",
    dlWinPortableBtn: "Tải Di động",
    dlMacTitle: "Máy tính macOS",
    dlMacBody:
      "Tải `.dmg` cho chip của bạn. Dùng `arm64` cho Apple Silicon và `x64` cho Intel Mac. Bản nhẹ dùng Tauri để giảm dung lượng gói nhưng vẫn đủ tính năng.",
    dlMacBtn: "Tải macOS",
    dlMacArmBtn: "Tải Apple Silicon",
    dlMacIntelBtn: "Tải Intel",
    dlLinuxTitle: "Máy tính Linux",
    dlLinuxBody:
      "Dùng bản Electron `.AppImage` để chạy di động hoặc `.deb` trên Debian và Ubuntu. Bản nhẹ dùng Tauri để giảm dung lượng gói nhưng vẫn đủ tính năng, có sẵn dưới dạng AppImage hoặc `.deb`.",
    dlLinuxBtn: "Tải Linux",
    dlLinuxAppImageBtn: "Tải AppImage",
    dlLinuxDebBtn: "Tải .deb",
    dlWinLightweightBtn: "Tải bản nhẹ",
    dlLinuxLightweightAppImageBtn: "Tải AppImage bản nhẹ",
    dlLinuxLightweightDebBtn: "Tải .deb bản nhẹ",
    dlMacLightweightBtn: "Tải bản nhẹ",
  ...
  fr: {
    ...
    dlWinBody:
      "Utilisez l’installateur NSIS pour les raccourcis du menu Démarrer et du bureau, ou le `.exe` portable pour l’exécuter directement sans installation. Les versions légères utilisent Tauri pour un bundle plus petit avec toutes les fonctionnalités.",
    ...
    dlMacBody:
      "Téléchargez un `.dmg` pour votre puce. Utilisez `arm64` pour Apple Silicon et `x64` pour les Mac Intel. Les versions légères utilisent Tauri pour un bundle plus petit avec toutes les fonctionnalités.",
    dlMacBtn: "Télécharger macOS",
    dlMacArmBtn: "Télécharger Apple Silicon",
    dlMacIntelBtn: "Télécharger Intel",
    dlLinuxTitle: "Bureau Linux",
    dlLinuxBody:
      "Utilisez la version Electron `.AppImage` pour un lancement portable, ou `.deb` sur les systèmes Debian et Ubuntu. Les versions légères utilisent Tauri pour un bundle plus petit avec toutes les fonctionnalités, en AppImage ou en `.deb`.",
    dlLinuxBtn: "Télécharger Linux",
    dlLinuxAppImageBtn: "Télécharger AppImage",
    dlLinuxDebBtn: "Télécharger .deb",
    dlWinLightweightBtn: "Télécharger version légère",
    dlLinuxLightweightAppImageBtn: "Télécharger AppImage légère",
    dlLinuxLightweightDebBtn: "Télécharger .deb légère",
    dlMacLightweightBtn: "Télécharger version légère",
  ...
  es: {
    ...
    dlWinBody:
      "Usa el instalador NSIS para accesos directos en el menú Inicio y el escritorio, o el `.exe` portable para ejecutarlo directamente sin instalación. Las versiones ligeras usan Tauri para un paquete más pequeño con todas las funciones.",
    ...
    dlMacBody:
      "Descarga un `.dmg` para tu chip. Usa `arm64` para Apple Silicon y `x64` para Mac Intel. Las versiones ligeras usan Tauri para un paquete más pequeño con todas las funciones.",
    dlMacBtn: "Descargar macOS",
    dlMacArmBtn: "Descargar Apple Silicon",
    dlMacIntelBtn: "Descargar Intel",
    dlLinuxTitle: "Escritorio Linux",
    dlLinuxBody:
      "Usa la versión Electron `.AppImage` para lanzamiento portable, o `.deb` en sistemas Debian y Ubuntu. Las versiones ligeras usan Tauri para un paquete más pequeño con todas las funciones, en AppImage o `.deb`.",
    dlLinuxBtn: "Descargar Linux",
    dlLinuxAppImageBtn: "Descargar AppImage",
    dlLinuxDebBtn: "Descargar .deb",
    dlWinLightweightBtn: "Descargar versión ligera",
    dlLinuxLightweightAppImageBtn: "Descargar AppImage ligera",
    dlLinuxLightweightDebBtn: "Descargar .deb ligera",
    dlMacLightweightBtn: "Descargar versión ligera",
  ...
  zh: {
    ...
    dlWinBody:
      "使用 NSIS 安装版可创建开始菜单和桌面快捷方式，或下载便携式 `.exe` 直接运行而无需安装。轻量版使用 Tauri，包体更小但功能完整。",
    dlWinBtn: "下载 Windows 版",
    dlWinNsisBtn: "下载安装版",
    dlWinPortableBtn: "下载便携版",
    dlMacTitle: "macOS 桌面",
    dlMacBody:
      "为您的芯片下载 `.dmg`。Apple Silicon 使用 `arm64`，Intel Mac 使用 `x64`。轻量版使用 Tauri，包体更小但功能完整。",
    dlMacBtn: "下载 macOS 版",
    dlMacArmBtn: "下载 Apple Silicon",
    dlMacIntelBtn: "下载 Intel",
    dlLinuxTitle: "Linux 桌面",
    dlLinuxBody:
      "可使用 Electron `.AppImage` 便携运行，或在 Debian 和 Ubuntu 系统上使用 `.deb`。轻量版使用 Tauri，包体更小但功能完整，并提供 AppImage 和 `.deb` 两种格式。",
    dlLinuxBtn: "下载 Linux 版",
    dlLinuxAppImageBtn: "下载 AppImage",
    dlLinuxDebBtn: "下载 .deb",
    dlWinLightweightBtn: "下载轻量版",
    dlLinuxLightweightAppImageBtn: "下载轻量版 AppImage",
    dlLinuxLightweightDebBtn: "下载轻量版 .deb",
    dlMacLightweightBtn: "下载轻量版",
    ...
    onVscodeMarketplace: "在 VS Code Marketplace 上",
    onOpenVsx: "在 Open VSX 上",
  ...
  no: {
    ...
    dlWinBody:
      "Bruk NSIS-installatøren for Start-meny- og skrivebordssnarveier, eller den bærbare `.exe`-filen for å kjøre direkte uten installasjon. Lettvektsversjoner bruker Tauri for mindre pakkestørrelse med full funksjonalitet.",
    ...
    dlMacBody:
      "Last ned en `.dmg` for brikken din. Bruk `arm64` for Apple Silicon og `x64` for Intel Mac. Lettvektsversjoner bruker Tauri for mindre pakkestørrelse med full funksjonalitet.",
    dlMacBtn: "Last ned macOS",
    dlMacArmBtn: "Last ned Apple Silicon",
    dlMacIntelBtn: "Last ned Intel",
    dlLinuxTitle: "Linux-skrivebord",
    dlLinuxBody:
      "Bruk Electron `.AppImage` for bærbar oppstart, eller `.deb` på Debian- og Ubuntu-baserte systemer. Lettvektsversjoner bruker Tauri for mindre pakkestørrelse med full funksjonalitet, som AppImage eller `.deb`.",
    dlLinuxBtn: "Last ned Linux",
    dlLinuxAppImageBtn: "Last ned AppImage",
    dlLinuxDebBtn: "Last ned .deb",
    dlWinLightweightBtn: "Last ned lettvektsversjon",
    dlLinuxLightweightAppImageBtn: "Last ned lettvekts AppImage",
    dlLinuxLightweightDebBtn: "Last ned lettvekts .deb",
    dlMacLightweightBtn: "Last ned lettvektsversjon",
  ...
  ja: {
    ...
    dlWinBody:
      "スタートメニューやデスクトップのショートカットには NSIS インストーラーを使い、インストール不要で直接実行したい場合はポータブル `.exe` を使います。軽量版は Tauri を使い、バンドルサイズが小さくても機能はフルです。",
    dlWinBtn: "Windows をダウンロード",
    dlWinNsisBtn: "インストーラーをダウンロード",
    dlWinPortableBtn: "ポータブル版をダウンロード",
    dlMacTitle: "macOS デスクトップ",
    dlMacBody:
      "チップ用の `.dmg` をダウンロードします。Apple Silicon には `arm64`、Intel Mac には `x64` を使用します。軽量版は Tauri を使い、バンドルサイズが小さくても機能はフルです。",
    dlMacBtn: "macOS をダウンロード",
    dlMacArmBtn: "Apple Silicon 版をダウンロード",
    dlMacIntelBtn: "Intel 版をダウンロード",
    dlLinuxTitle: "Linux デスクトップ",
    dlLinuxBody:
      "Electron の `.AppImage` はポータブル起動向け、`.deb` は Debian / Ubuntu 系向けです。軽量版は Tauri を使い、バンドルサイズが小さくても機能はフルで、AppImage と `.deb` を用意しています。",
    dlLinuxBtn: "Linux をダウンロード",
    dlLinuxAppImageBtn: "AppImage をダウンロード",
    dlLinuxDebBtn: ".deb をダウンロード",
    dlWinLightweightBtn: "軽量版をダウンロード",
    dlLinuxLightweightAppImageBtn: "軽量版 AppImage をダウンロード",
    dlLinuxLightweightDebBtn: "軽量版 .deb をダウンロード",
    dlMacLightweightBtn: "軽量版をダウンロード",
    ...
    onVscodeMarketplace: "VS Code Marketplace で",
    onOpenVsx: "Open VSX で",
  ...
  ko: {
    ...
    dlWinBody:
      "시작 메뉴와 바탕화면 바로가기가 필요하면 NSIS 설치 파일을 사용하고, 설치 없이 바로 실행하려면 포터블 `.exe`를 사용합니다. 경량 버전은 Tauri를 사용해 번들 크기가 더 작지만 기능은 그대로입니다.",
    dlWinBtn: "Windows 다운로드",
    dlWinNsisBtn: "설치 파일 다운로드",
    dlWinPortableBtn: "포터블 다운로드",
    dlMacTitle: "macOS 데스크톱",
    dlMacBody:
      "칩에 맞는 `.dmg`를 다운로드합니다. Apple Silicon에는 `arm64`, Intel Mac에는 `x64`를 사용합니다. 경량 버전은 Tauri를 사용해 번들 크기가 더 작지만 기능은 그대로입니다.",
    dlMacBtn: "macOS 다운로드",
    dlMacArmBtn: "Apple Silicon 다운로드",
    dlMacIntelBtn: "Intel 다운로드",
    dlLinuxTitle: "Linux 데스크톱",
    dlLinuxBody:
      "휴대용 실행에는 Electron `.AppImage`를, Debian 및 Ubuntu 기반 시스템에는 `.deb`를 사용합니다. 경량 버전은 Tauri를 사용해 번들 크기가 더 작지만 기능은 그대로이며, AppImage와 `.deb` 둘 다 제공합니다.",
    dlLinuxBtn: "Linux 다운로드",
    dlLinuxAppImageBtn: "AppImage 다운로드",
    dlLinuxDebBtn: ".deb 다운로드",
    dlWinLightweightBtn: "경량 버전 다운로드",
    dlLinuxLightweightAppImageBtn: "경량 AppImage 다운로드",
    dlLinuxLightweightDebBtn: "경량 .deb 다운로드",
    dlMacLightweightBtn: "경량 버전 다운로드",
  ...
  ru: {
    ...
    dlWinBody:
      "Используйте установщик NSIS для ярлыков в меню «Пуск» и на рабочем столе, либо портативный `.exe`, чтобы запускать приложение напрямую без установки. Лёгкие версии используют Tauri для меньшего размера пакета при полном наборе функций.",
    ...
    dlMacBody:
      "Скачайте `.dmg` для вашего чипа. Используйте `arm64` для Apple Silicon и `x64` для Intel Mac. Лёгкие версии используют Tauri для меньшего размера пакета при полном наборе функций.",
    dlMacBtn: "Скачать macOS",
    dlMacArmBtn: "Скачать Apple Silicon",
    dlMacIntelBtn: "Скачать Intel",
    dlLinuxTitle: "Linux рабочий стол",
    dlLinuxBody:
      "Используйте Electron `.AppImage` для портативного запуска или `.deb` на системах Debian и Ubuntu. Лёгкие версии используют Tauri для меньшего размера пакета при полном наборе функций и доступны как AppImage и `.deb`.",
    dlLinuxBtn: "Скачать Linux",
    dlLinuxAppImageBtn: "Скачать AppImage",
    dlLinuxDebBtn: "Скачать .deb",
    dlWinLightweightBtn: "Скачать лёгкую версию",
    dlLinuxLightweightAppImageBtn: "Скачать лёгкий AppImage",
    dlLinuxLightweightDebBtn: "Скачать лёгкий .deb",
    dlMacLightweightBtn: "Скачать лёгкую версию",
