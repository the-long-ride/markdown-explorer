...
pub struct AppStateInner {
    ...
    pub insights_watch_controller: Option<crate::workspace::watch::WorkspaceWatchController>,
    pub insights_cancelled_scans: HashSet<String>,
    pub insights_cancelled_external_checks: HashSet<String>,
