...
**Date:** 2026-09-06  
**Status:** Approved historical design draft — superseded where noted  
**Branch:** `feature/editor-git-history-split-view`

> **As-built synchronization (2026-09-17):** This document is retained as the initial design history. Where it conflicts with [`2026-09-17-pr48-as-built-sync.md`](2026-09-17-pr48-as-built-sync.md), the as-built specification and implementation are authoritative. In particular, the final PR uses locally packaged CodeMirror 6 for full-source editing, pane-owned split tabs, paged/searchable repository History, revision file filtering, and repository-sidebar routing for More Actions → History.
