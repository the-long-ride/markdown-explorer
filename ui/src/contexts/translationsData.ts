...
export const TRANSLATIONS: Record<AppLanguage, Translations> = {
  ...
  vi: {
    ...
    documentConversionDesc: "Chuyển đổi DOCX, PDF, HTML, XLSX, PPTX, ODT, ODP, ODS và RTF sang Markdown để xem trước. Bản xem trước có thể giảm chất lượng bố cục hoặc định dạng.",
  ...
  fr: {
    ...
    documentConversionDesc: "Convertit les fichiers DOCX, PDF, HTML, XLSX, PPTX, ODT, ODP, ODS et RTF en Markdown pour aperçu. Les aperçus convertis peuvent perdre en qualité de mise en page ou de formatage.",
  ...
  es: {
    ...
    documentConversionDesc: "Convierte DOCX, PDF, HTML, XLSX, PPTX, ODT, ODP, ODS y RTF a Markdown para vista previa. Las vistas previas convertidas pueden perder calidad de diseño o formato.",
  ...
  zh: {
    ...
    documentConversionDesc: "将 DOCX、PDF、HTML、XLSX、PPTX、ODT、ODP、ODS 和 RTF 转换为 Markdown 进行预览。转换后的预览可能会丢失布局或格式质量。",
  ...
  no: {
    ...
    documentConversionDesc: "Konverterer DOCX, PDF, HTML, XLSX, PPTX, ODT, ODP, ODS og RTF til Markdown for forhåndsvisning. Konverterte forhåndsvisninger kan miste oppsett eller formateringskvalitet.",
  ...
  ja: {
    ...
    documentConversionDesc: "DOCX、PDF、HTML、XLSX、PPTX、ODT、ODP、ODS、RTF ファイルを Markdown に変換してプレビューします。変換されたプレビューは、レイアウトやフォーマットの品質が低下する場合があります。",
  ...
  ko: {
    ...
    documentConversionDesc: "DOCX, PDF, HTML, XLSX, PPTX, ODT, ODP, ODS, RTF 파일을 Markdown으로 변환하여 미리 봅니다. 변환된 미리보기는 레이아웃이나 서식 품질이 저하될 수 있습니다.",
  ...
  ru: {
    ...
    documentConversionDesc: "Преобразует DOCX, PDF, HTML, XLSX, PPTX, ODT, ODP, ODS и RTF в Markdown для предварительного просмотра. Качество разметки и форматирования при преобразовании может ухудшиться.",
