export interface Translations {
  ...
  fileTabs: string;
  fileTabsDesc: string;
  bookmarksEnabled: string;
  bookmarksEnabledDesc: string;
  bookmarks: {
    tab: string;
  ...
  search: {
    dialogLabel: string;
    modalTitleCurrent: string;
    modalTitleAllTabs: string;
    queryLabel: string;
    currentWorkspacePlaceholder: string;
    allWorkspacesPlaceholder: string;
    indexingPlaceholder: string;
    workspaces: string;
    ...
    sidebarInputLabel: string;
    minimumCharacters: string;
    searchingWorkspace: string;
