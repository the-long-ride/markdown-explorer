...
export function SettingsPreferencesPanel({
  ...
  return (
    <div className="settings-card__column settings-card__column--preferences settings-card__column--section">
      ...
      {section === 'features' && (
        <section className="settings-section-panel settings-features-section">
          <div className="settings-section-panel__header">
            <h3>{featureT.features}</h3>
          ...
          <div className="settings-appearance-controls">
            ...
            >
              <label className="switch-toggle" aria-label={featureT.historySidebarEnabled}>
                <input
                  type="checkbox"
            ...
            >
              <label className="switch-toggle" aria-label={featureT.markdownEditingEnabled}>
                <input
                  type="checkbox"
