...
export function SearchResultFileView({
  file,
  query,
  matchCase,
  collapsedPaths,
  ...
  onOpenResult?: (match: WorkspaceSearchResult) => void;
}) {
...
export function SearchResultFolderView({
  node,
  query,
  matchCase,
  collapsedPaths,
