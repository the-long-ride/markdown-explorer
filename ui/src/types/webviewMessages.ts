...
export interface ListRepositoryHistoryMessage { readonly command: 'listRepositoryHistory'; readonly requestId: string; readonly limit?: number; readonly offset?: number; }
